...
needle.update_params("resin_duct", "n_files", 3)
...
needle.update_params("transfusion_tissue", "transfusion_tracheids_ratio", 2)
needle.update_params("transfusion_tissue", "tracheids_diameter", 0.07)
needle.update_params("transfusion_tissue", "parenchyma_diameter", 0.02)
