...
class NeedleAnatomy(Organ):
    ...
    def _initialize_default_params(self) -> Dict[str, Any]:
        ...
        self.params = [
            # P. pinaster
            {"name": "planttype", "value": 3, "organ": "needle", "width": 2.05, "thickness": 0.96}, # global parameters
            ...
            {"name": "central_cylinder", "cell_diameter": 0.02, "layer_thickness": 0.43, "layer_length": 1.05}, # Cell diameter in millimeters
    ...
    def _create_vascular_tissue(self, polygons: List[Polygon]):
        ...
        vascular_polygons = unary_union(polygons)
        self.all_cells = [
